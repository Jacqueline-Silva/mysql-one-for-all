...
CREATE TABLE SpotifyClone.historic_reproductions(
  user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.users
  (user_name, user_age, plan_id, subscribed)
VALUES
...
INSERT INTO SpotifyClone.historic_reproductions
  (user_id, song_id, date_reproduction)
VALUES
